...
resource "mongodbatlas_private_endpoint_interface_link" "myatlas-service" {
  project_id            = "${mongodbatlas_private_endpoint.privateLink.project_id}"
  private_link_id       = "${mongodbatlas_private_endpoint.privateLink.private_link_id}"
